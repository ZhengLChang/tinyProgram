...
http://d.10jqka.com.cn/v2/realhead/hs_002594/last.js
 * */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
static const char *file_len_terminator (const char *start, const char *peeked, int peeklen)
{
  const char *p, *end;
...
static char *read_http_body_len_head (int fd)
{
